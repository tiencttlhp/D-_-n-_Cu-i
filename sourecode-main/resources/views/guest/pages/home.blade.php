			...
			<section class="section" id="section_2048585915">
				...
				<div class="section-content relative">
					...
					<div class="row" id="row-647038131">
						<div class="col medium-13 small-13 large-13">
							<div class="col-inner">
								...
								<div class="col-inner">
									<div class="clearfix vi-header">
										<h3 class="vi-left-title pull-left">
											<a href="{{ route('getAllKhuyenMai') }}">KHUYẾN MÃI HOT NHẤT</a>
										</h3>
						...
						<div class="col small-12 large-12">
							<div class="col-inner">
								<div class="col-inner">
									<div class="clearfix vi-header">
										<h3 class="vi-left-title pull-left">
											<a href="{{ route('getAllSmartPhone') }}">ĐIỆN THOẠI</a>
										</h3>
										<div class="vi-right-link pull-right" style="font-weight: bold;">
						...
						<div class="col small-12 large-12">
							<div class="col-inner">
								<div class="col-inner">
									<div class="clearfix vi-header">
										<h3 class="vi-left-title pull-left">
											<a href="{{ route('getAllLaptop') }}">LAPTOP
												<br />
											</a>
										</h3>
										<div class="vi-right-link pull-right" style="font-weight: bold;">
								...
								<div class="col-inner">
									<div class="clearfix vi-header">
										<h3 class="vi-left-title pull-left">
											<a href="{{ route('getAllTablet') }}">TABLET
												<br />
											</a>
										</h3>
										<div class="vi-right-link pull-right" style="font-weight: bold;">
								...
								<div class="col-inner">
									<div class="clearfix vi-header">
										<h3 class="vi-left-title pull-left">
											<a href="{{ route('getAllAccessory') }}">PHỤ KIỆN
												<br />
											</a>
										</h3>
										<div class="vi-right-link pull-right" style="font-weight: bold;">
					...
					<div class="row" id="row-1623465142">
						...
						<div class="col medium-13 small-13 large-13">
							<div class="col-inner">
								...
								<!-- .section-title -->
								<div class="slider-wrapper relative col small-10 large-10" id="slider-1145187929" style="margin: 10px auto">
										...
										<div class="row" id="row-964714422" >
												...
												<div class="col-inner">
													<div class="icon-box featured-box icon-box-center text-center">
														...
														<div class="icon-box-text last-reset">
															...
															<p style="text-align: center;">
																<span style="color: #000000; font-size: 85%;">Sau nhiều năm sử dụng dịch vụ Sửa Chữa Điện Thoại và mua rất nhiều Điện Thoại tại TrueSmart. Việt Anh cảm thấy hài lòng và tin tưởng &#8230; TÔI TIN TƯỞNG VÀ CHỌN ShOP!!</span>
															</p>
														</div>
													</div>
													<!-- .icon-box -->
											...
											<style scope="scope">
	                                            #row-964714422 > .col > .col-inner {
	                                                background-color: rgb(238, 237, 236)3);
	                                            }
	                                        </style>
										</div>
												...
												<div class="col-inner">
													<div class="icon-box featured-box icon-box-center text-center">
														...
														<div class="icon-box-text last-reset">
															...
															<p style="text-align: center;">
																<span style="color: #000000; font-size: 85%;">Sau nhiều năm sử dụng dịch vụ Sửa Chữa Điện Thoại và mua rất nhiều Điện Thoại tại đây. Việt Anh cảm thấy hài lòng và tin tưởng &#8230; TÔI TIN TƯỞNG VÀ CHỌN CÁC BẠN!!</span>
															</p>
														</div>
													</div>
													<!-- .icon-box -->
