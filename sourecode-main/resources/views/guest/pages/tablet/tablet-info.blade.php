  		...
  		<div class="flex-col flex-grow medium-text-center">
  			<div class="is-small">
  				<nav class="woocommerce-breadcrumb breadcrumbs">
  					...
  					<a href="{{ route('getAllTablet') }}">Máy Tính Bảng</a>
  					<span class="divider">/</span>
  					<a href="{{ route('getTabletByHang',$s->manufacturer) }}">{{ strtoupper($s->manufacturer) }}</a>
  					<span class="divider">/</span>
              ...
              <div class="row">
                ...
                <div class="product-info summary entry-summary col col-fit product-summary form-flat">
                  ...
                  @if ($s->status==1 && $s->quantity>0)
                    <form class="variations_form cart" action="{{ route('postTabletAddCart') }}" method="post" enctype='multipart/form-data'>    
