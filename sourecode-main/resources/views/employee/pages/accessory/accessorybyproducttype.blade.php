										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a href="{{ route('getEditAccessory',$element->accessoryid) }}"><i class="icon-database-refresh"></i> Sửa</a></li>
													<li><a class="deleteAccessory" sw_title="Thông báo" sw_contnet="Bạn muốn xóa phụ kiện?" sw_notice="Xóa thành công." sw_url=" {{ route('getDeleteAccessory',$element->accessoryid) }} "><i class="icon-database-remove"></i> Xóa</a></li>
												</ul>
											</li>
										</ul>
									</td>
