										...
										<ul class="icons-list">
											<li class="dropdown">
												...
												<ul class="dropdown-menu dropdown-menu-right">
													...
													<li><a href="{{ route('getEditSmartPhone',$element->smartphoneid) }}"><i class="icon-database-refresh"></i> Sửa</a></li>
													<li><a class="deleteSmartPhone" sw_title="Thông báo" sw_contnet="Bạn muốn xóa điện thoại này?" sw_notice="Xóa thành công." sw_url=" {{ route('getDeleteSmartPhone',$element->smartphoneid) }} "><i class="icon-database-remove"></i> Xóa</a></li>
												</ul>
											</li>
										</ul>
									</td>
